...
const QuoteGenerator = () => {
    ...
    const[image, setImage] = useState("https://images.unsplash.com/photo-1421789665209-c9b2a435e3dc?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8bmF0dXJlfGVufDB8fDB8fHwy");

    let motovationalQuotes = [
        {
      ...
      function generateQuote(){
        console.log("hello");
        const randomIndex = Math.floor(Math.random() * motovationalQuotes.length);
        setQuote(motovationalQuotes[randomIndex].text);
        setImage(motovationalQuotes[randomIndex].image);
